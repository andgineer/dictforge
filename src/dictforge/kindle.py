...
def guess_kindlegen_path() -> str:
    ...
    candidates = []
    if system == "Darwin":
        candidates.append("/Applications/Kindle Previewer 3.app/Contents/MacOS/lib/fc/bin/kindlegen")
    elif system == "Windows":
        home = os.environ.get("USERPROFILE") or os.environ.get("HOMEPATH") or "C:\\Users\\Public"
        candidates.append(str(Path(home) / "AppData/Local/Amazon/Kindle Previewer 3/lib/fc/bin/kindlegen.exe"))
    else:
